      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-16">
          <div className="md:col-span-2">
            ...
            <p className="text-sm font-body font-light text-[#FDFCFB]/30 leading-relaxed max-w-sm">
              The world&apos;s first architecturally stratified chocolate experience. Handcrafted in small batches. Delivered in climate-controlled vessels.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                href="mailto:hello@triadbar.com"
                className="text-sm font-body font-light text-[#FDFCFB]/40 hover:text-[#C9974C] transition-colors"
              >
                hello@triadbar.com
              </a>
        ...
        <div className="mt-16 pt-8 border-t border-[#FDFCFB]/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-[11px] font-body text-[#FDFCFB]/20">
            © 2025 Triad Confections AG. All rights reserved.
          </span>
          <div className="flex items-center gap-6">
            <a
              href="mailto:hello@triadbar.com"
              className="text-[11px] font-body text-[#FDFCFB]/20 hover:text-[#C9974C]/60 transition-colors"
            >
              Privacy Policy
            </a>
            <a
