...
export const layers: Layer[] = [
  {
    ...
    subtitle: "Top Layer",
    description:
      "72% single-origin Ecuadorian cacao. A thin, crystalline shell tempered to an audible 4,200 Hz snap - the sound of perfection breaking open.",
  ...
  apex: [
    {
      id: "salted-caramel",
      name: "Salted Caramel",
      description: "Fleur de sel from Guérande meets aged Normandy butter",
      color: "#C9974C",
      image: `${M}/47df75ad4_generated_1237f540.png`,
    },
    {
...
export const pillars: Pillar[] = [
  {
    number: "01",
    title: "The 51.5° Angle",
    stat: "51.5°",
    statLabel: "Pyramid Slope",
    description:
      "The exact slope of the Great Pyramid of Giza. Every diagonal line in our brand world - packaging, logo, UI, store design, ad typography - is set at precisely 51.5°. No exceptions. A mathematical signature no competitor can replicate.",
  },
  {
    number: "02",
    title: "The Ascent",
    stat: "Base → Core → Apex",
    statLabel: "Eating Ritual",
    description:
      "You don't bite a Triad. You climb it. The ritual: start at the dark, heavy foundation, ascend through the molten core, and finish at the crystalline apex. A 15-second tasting sequence people will demonstrate, film, and share.",
  },
  {
    number: "03",
    title: "The Resonant Snap",
    stat: "4,200 Hz",
    statLabel: "Audio Trademark",
    description:
      "The apex layer is tempered to break at a specific audible frequency. The sound of our chocolate snapping is engineered, recorded, and trademarked - our audio logo. Not a jingle. The physics of the product itself.",
  },
  {
    number: "04",
    title: "The Unveiling",
    stat: "Magnetic",
    statLabel: "Packaging Ritual",
    description:
      "Every bar arrives in a matte-black triangular reliquary. The magnetic closure resists, then yields. The pyramid rests on a recessed slate tray, held by geometry alone. No plastic. No foam. An artifact, not a wrapper.",
  },
  {
    number: "05",
    title: "The Stratum Lexicon",
    stat: "7 terms",
    statLabel: "Brand Vocabulary",
    description:
      "We don't say flavors - we say strata. Not layers - formations. Not filling - the core. Not bestseller - the summit. Our vocabulary creates tribal identity. When people use our words, they've internalized the brand.",
  },
  {
    number: "06",
    title: "Obsidian & Gold",
    stat: "0% brown",
    statLabel: "Color Protocol",
    description:
      "Every chocolate brand uses brown. We never do. Obsidian black and burnished gold, exclusively - with filling colors appearing only as accent flashes when a layer is revealed. On a shelf of brown wrappers, we are the monolith.",
  },
  {
    number: "07",
    title: "The Triad System",
    stat: "3 × 3 × 3",
    statLabel: "Combinatorial Architecture",
    description:
      "We don't sell flavors. We sell a system of interchangeable layers. Each stratum is available in multiple variants - combine three to form a complete bar. New product launches are new layers, not new bars. Infinite compositions.",
  },
  {
    number: "08",
    title: "The Summit",
    stat: "2 syllables",
    statLabel: "The Moment We Own",
    description:
      "KitKat owns the break. We own the summit - the instant you reach the apex and the crystalline shell snaps, releasing the final burst of flavor. Reach the summit. A moment, a compliment, a mood, a farewell.",
  },
];
